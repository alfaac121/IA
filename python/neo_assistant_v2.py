...
class FloatingTerminal(QWidget):
    ...
    def init_ui(self):
        ...
        # Container con estilo Kali (SIN BORDE)
        container = QWidget()
        ...
        # Output area - SIN SCROLLBAR VISIBLE
        ...
        # Banner sin arte ASCII - solo logo
        import platform
        
        self.output.setHtml(f"""
<pre style='line-height: 1.1; font-family: monospace; font-size: 12px;'>

    <span style='color: #00ff00;'>███╗   ██╗███████╗ ██████╗</span>     <span style='color: #00d4ff;'>████████╗███████╗██████╗ ███╗   ███╗</span>
    <span style='color: #00ff00;'>████╗  ██║██╔════╝██╔═══██╗</span>    <span style='color: #00d4ff;'>╚══██╔══╝██╔════╝██╔══██╗████╗ ████║</span>
    <span style='color: #00ff00;'>██╔██╗ ██║█████╗  ██║   ██║</span>       <span style='color: #00d4ff;'>██║   █████╗  ██████╔╝██╔████╔██║</span>
    <span style='color: #00ff00;'>██║╚██╗██║██╔══╝  ██║   ██║</span>       <span style='color: #00d4ff;'>██║   ██╔══╝  ██╔══██╗██║╚██╔╝██║</span>
    <span style='color: #00ff00;'>██║ ╚████║███████╗╚██████╔╝</span>       <span style='color: #00d4ff;'>██║   ███████╗██║  ██║██║ ╚═╝ ██║</span>
    ...
    <span style='color: #00d4ff;'>│</span>  <span style='color: #00ff00;'>[SYSTEM INITIALIZED]</span> <span style='color: #888;'>Advanced Terminal Interface v2.0</span>          <span style='color: #00d4ff;'>│</span>
    <span style='color: #00d4ff;'>│</span>  <span style='color: #00ff00;'>[ACCESS GRANTED]</span> <span style='color: #888;'>Full System Control Enabled</span>                   <span style='color: #00d4ff;'>│</span>
    <span style='color: #00d4ff;'>│</span>  <span style='color: #00ff00;'>[SECURITY]</span> <span style='color: #888;'>Encrypted Connection Established</span>                    <span style='color: #00d4ff;'>│</span>
    <span style='color: #00d4ff;'>└─────────────────────────────────────────────────────────────────┘</span>
</pre>
""")
        self.add_output("[+] System ready - Type 'ayuda' for available commands", "#00d4ff")
        self.add_output(f"[*] Current directory: {os.getcwd()}", "#888")
        self.add_output(f"[*] Session started: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n", "#888")
        ...
        prompt_line1 = QLabel("┌──(neo㉿system)-[~]")
    ...
    def execute_command(self):
        ...
        # Mostrar comando con prompt estilo Kali
        self.add_output(f"<span style='color: #00d4ff;'>┌──(</span><span style='color: #00ff00;'>neo㉿system</span><span style='color: #00d4ff;'>)-[~]</span>", "#00d4ff")
        self.add_output(f"<span style='color: #00d4ff;'>└─$</span> <span style='color: #ffffff;'>{command}</span>", "#00d4ff")
        self.input.clear()
...
""")
            self.add_output("[+] Terminal cleared", "#00d4ff")
